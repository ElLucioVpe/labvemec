<%-- 
    Document   : secciones
    Created on : 13-jul-2020, 23:54:43
    Author     : Esteban
--%>
        ...
        <div class="container-fluid">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Agregar Seccion</div>
                    </div>
                    <div class="col-auto">
          ...
          <div class="row">
                <c:forEach var="slave" items="${lista}">
                    <!-- Seccion -->
                    <div class="col-xl-3 col-md-6 mb-4">
                      <a href="seccion?id=${slave.id}">
                      <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                          <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                              <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">${slave.Nombre}</div>
                            </div>
                          </div>
                        </div>
                      </div>
